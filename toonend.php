...
<!--    <div class="adv_main">상 단 광 고</div>	-->
    ...
    <main class="main_wrapper">
            <div class="recommend_main_header">
                <div class="recomend_main_title"><span>완결 웹툰</span></div>
                <div class="sort_nav_wrapper2">
					...
					<a href="toonend.php?popularity=star">
						<div class="sort_nav02"><span>평점순</span></div>
					</a>
					<a href="toonend.php?popularity=update">
					...
					<?php
						...
						{
					?>
					<a href="toonend.php?popularity=view">
            ...
            <div class="popularity_main_content_wrapper">
                <ul class="recommend_main_contents">
					...
					foreach($result as $r){
						if($r['content_end'] == true && $r['user_toon'] == false){?>
