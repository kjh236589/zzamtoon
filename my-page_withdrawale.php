    ...
    <main class="main_wrapper my-page">
        <section class="menus">
            ...
            <ul class="navs">
                ...
                <a href="my-page_withdrawale.php"><li class="nav" style="background-color: rgb(255, 139, 139); width: 165px;"><span>회원탈퇴</span></li></a>
            </ul>
        </section>
        <section class="view">
            <div class="member_pwd_title"><span>회원탈퇴</span></div>
            <section class="table member">
                <table>
                    <form class="form" method="POST" action="withdrawale.php" >
