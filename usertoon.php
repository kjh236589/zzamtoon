...
<!--    <div class="adv_main">상 단 광 고</div>	-->
    ...
    <main class="main_wrapper">
            <div class="recommend_main_header">
                <div class="recomend_main_title"><span>유저툰</span></div>
                <div class="sort_nav_wrapper2">
					<?php
						if($_GET['popularity'] == "view")
						{
					?>
					<div class="sort_nav01"><span>조회순</span></div>
					<a href="usertoon.php?popularity=star">
						<div class="sort_nav02"><span>평점순</span></div>
					</a>
					<a href="usertoon.php?popularity=update">
						<div class="sort_nav03"><span>업데이트순</span></div>
					</a>
					<?php
						}else if($_GET['popularity'] == "star")
						{
					?>
					<a href="usertoon.php?popularity=view">
					...
					<?php
						}else if($_GET['popularity'] == "update")
						{
					?>
					<a href="usertoon.php?popularity=view">
						<div class="sort_nav02"><span>조회순</span></div>
					...
					<a href="usertoon.php?popularity=star">
						<div class="sort_nav03"><span>평점순</span></div>
					</a>
					<div class="sort_nav01"><span>업데이트순</span></div>
					<?php
						}
					?>
                </div>
							...
							<li class="recommend_main_content">
								<a href="contents_detail.php?content_code=<?php echo "$r[content_code]"?>">
									...
									<div class="content_text_wrapper">
										...
										?>
										<div class="content_name_wrapper">
											<span class="content_rest"><?php echo "$r[content_name]"?></span>
										</div>
										<div class="content_name_wrapper">
											<span class="content_rest">완결</span>
										</div>
										<?php
										}
										?>
